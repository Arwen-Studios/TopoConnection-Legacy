...
function onCreatePost()
	...
	local texture = 'noteskins/opponent/' .. (getProperty('opponentMode') and 'Nxxty' or 'boyfriend')
...
function onUpdate()
	...
	if (curStep == 640) then
		...
		noteTweenY('psX', 6, 50, 8, 'expoOut')
		noteTweenY('hcZ', 7, 50, 8, 'expoOut')
		noteTweenY('p3X', 4, 50, 8, 'expoOut')
		noteTweenY('h0Z', 5, 50, 8, 'expoOut')
	end
	...
	if (curStep == 1151) then
		...
		noteTweenY('psX', 6, 570, 8, 'expoOut')
		noteTweenY('hcZ', 7, 570, 8, 'expoOut')
		noteTweenY('p3X', 4, 570, 8, 'expoOut')
		noteTweenY('h0Z', 5, 570, 8, 'expoOut')
	end
