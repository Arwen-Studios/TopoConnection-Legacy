...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		changeModeText.setFormat(Paths.font(Std.string(Main.gameFont)), 32, FlxColor.WHITE, CENTER);
	...
	function createTexts()
	{
		for (i in 0...7)
		{
			var text:FlxText = new FlxText(10, 50 + (i * 30), 0, '', 24);
			text.setFormat(Paths.font(Std.string(Main.gameFont)), 24, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
