...
class CharacterEditorState extends MusicBeatState
{
	...
	override function create()
	{
		...
		textAnim.setFormat(Paths.font("mode-seven.ttf"), 16, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	function addSettingsUI()
	{
		...
		var templateCharacter:FlxButton = new FlxButton(140, 50, "Load Template", function()
		{
			...
			for (character in characters)
			{
				...
				character.noteSkinFile = parsedJson.noteSkin;
	...
	function addCharacterUI()
	{
		...
		noteSkinInputText = new FlxUIInputText(healthIconInputText.x + 95, imageInputText.y + 35, 80, 'NOTE_assets', 8);
		...
		tab_group.add(new FlxText(noteSkinInputText.x - 1, healthIconInputText.y - 18, 0, 'Note skin file name:'));
